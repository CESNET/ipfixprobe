...
struct QUICVersion {
    ...
    , generation({})
    {
        ...
        if (static_cast<QUICVersionId>(id & 0x0F0F0F0F) 
                == QUICVersionId::force_ver_neg_pattern) {
            // Version 1
            draft = 35;
        ...
        case QUICVersionId::ms_quic:
            ...
            generation = QUICGeneration::V1;
            return;
        case QUICVersionId::ethz: [[fallthrough]];
        case QUICVersionId::telecom_italia: [[fallthrough]];
        case QUICVersionId::tencent_quic: [[fallthrough]];
        case QUICVersionId::quinn_noise: [[fallthrough]];
        ...
        case QUICVersionId::quant:
            generation = QUICGeneration::V0;
            return;
        case QUICVersionId::quic_go: [[fallthrough]];
        ...
        case QUICVersionId::facebook3: [[fallthrough]];
        case QUICVersionId::facebook4: [[fallthrough]];
        case QUICVersionId::facebook_experimental: [[fallthrough]];
        ...
        case QUICVersionId::q_version2:
            ...
            generation = QUICGeneration::V2;
            return;
        case QUICVersionId::facebook_v1_alias: [[fallthrough]];
        default:
            draft = 255;
            generation = QUICGeneration::V1;
            return;
