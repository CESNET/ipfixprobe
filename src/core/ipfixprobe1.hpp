...
struct ipxp_conf_t {
   ...
   std::vector<std::unique_ptr<InputPlugin>> m_inputPlugins;
   std::vector<std::unique_ptr<StoragePlugin>> m_storagePlugins;
   std::vector<std::unique_ptr<ProcessPlugin>> m_processPlugins;
   std::vector<std::unique_ptr<OutputPlugin>> m_outputPlugins;
