...
int RecordExtNETBIOS::REGISTERED_ID = register_extension();
...
static const PluginRegistrar<NETBIOSPlugin, ProcessPluginFactory> netbiosRegistrar(netbiosPluginManifest);
