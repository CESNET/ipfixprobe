...
int RecordExtBSTATS::REGISTERED_ID = register_extension();

constexpr struct timeval BSTATSPlugin::min_packet_in_burst =
...
static const PluginRegistrar<BSTATSPlugin, ProcessPluginFactory> bstatsRegistrar(bstatsPluginManifest);
