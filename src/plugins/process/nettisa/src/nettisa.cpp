...
int RecordExtNETTISA::REGISTERED_ID = register_extension();

static const PluginManifest nettisaPluginManifest = {
    .name = "nettisa",
    .description = "Nettisa process plugin for computing packet bursts stats.",
    .pluginVersion = "1.0.0",
    .apiVersion = "1.0.0",
 };
...
static const PluginRegistrar<NETTISAPlugin, ProcessPluginFactory> nettisaRegistrar(nettisaPluginManifest);
