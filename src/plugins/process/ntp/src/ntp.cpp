...
createNetworkTimeSchema(FieldManager& fieldManager, FieldHandlers<NetworkTimeFields>& handlers)
{
	...
	handlers.insert(
		...
		schema.addScalarField("NTP_LEAP", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->leap;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_VERSION,
		schema.addScalarField("NTP_VERSION", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->version;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_MODE,
		schema.addScalarField("NTP_MODE", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->mode;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_STRATUM,
		schema.addScalarField("NTP_STRATUM", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->stratum;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_POLL,
		schema.addScalarField("NTP_POLL", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->poll;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_DELAY,
		schema.addScalarField("NTP_DELAY", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->delay;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_DISPERSION,
		schema.addScalarField("NTP_DISPERSION", [](const void* context) {
			return reinterpret_cast<const NetworkTimeData*>(context)->dispersion;
		}));

	handlers.insert(
		NetworkTimeFields::NTP_REF_ID,
		schema.addScalarField("NTP_REF_ID", [](const void* context) {
			return toStringView(reinterpret_cast<const NetworkTimeData*>(context)->referenceId);
		}));

	handlers.insert(
		NetworkTimeFields::NTP_REF,
		schema.addScalarField("NTP_REF", [](const void* context) {
			return toStringView(reinterpret_cast<const NetworkTimeData*>(context)->reference);
		}));

	handlers.insert(
		NetworkTimeFields::NTP_ORIG,
		schema.addScalarField("NTP_ORIG", [](const void* context) {
			return toStringView(reinterpret_cast<const NetworkTimeData*>(context)->origin);
		}));

	handlers.insert(
		NetworkTimeFields::NTP_RECV,
		schema.addScalarField("NTP_RECV", [](const void* context) {
			return toStringView(reinterpret_cast<const NetworkTimeData*>(context)->receive);
		}));

	handlers.insert(
		NetworkTimeFields::NTP_SENT,
		schema.addScalarField("NTP_SENT", [](const void* context) {
			return toStringView(reinterpret_cast<const NetworkTimeData*>(context)->sent);
		}));
...
static boost::static_string<NetworkTimeData::MAX_TIMESTAMP_AS_TEXT_LENGTH>
...
static bool
fillNetworkTimeHeader(NetworkTimeHeader networkTimeHeader, NetworkTimeData& pluginData) noexcept
{
...
constexpr boost::static_string<NetworkTimeData::MAX_IP4_AS_TEXT_LENGTH> getReferenceIdAsString(
	...
	NetworkTimeData& pluginData) noexcept
{
	...
	pluginData.referenceId = getReferenceIdAsString(
