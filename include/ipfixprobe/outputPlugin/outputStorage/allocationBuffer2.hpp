...
class AllocationBuffer2 : public AllocationBufferBase<ElementType> {
public:
	explicit AllocationBuffer2(const std::size_t capacity, const uint8_t writersCount) noexcept
