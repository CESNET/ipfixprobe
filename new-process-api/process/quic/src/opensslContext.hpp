 ...
 *
 * This lambda function initializes an EVP_PKEY_CTX context for HKDF (HMAC-based Extract-and-Expand Key Derivation Function).
 * The context is wrapped which ensures proper cleanup using EVP_PKEY_CTX_free.
 *
